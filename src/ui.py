...
class Hex2DecQt(QMainWindow):
    ...
    def setup_conversion_widgets(self):
        ...
        self.hex_text.setStyleSheet("font-family: 'Roboto Mono', 'Courier New', monospace; font-weight: 400; font-size: 10pt;")
        ...
        self.dec_text.setStyleSheet("font-family: 'Roboto Mono', 'Courier New', monospace; font-weight: 400; font-size: 10pt;")
        ...
        self.bin_text.setStyleSheet("font-family: 'Roboto Mono', 'Courier New', monospace; font-weight: 400; font-size: 10pt;")
