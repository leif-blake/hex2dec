...
hex_label = tk.Label(frame, text="Hexadecimal")
hex_label.grid(row=2, column=0, padx=5, pady=5, sticky="nw")
hex_text = tk.Text(frame, width=20, height=15)
hex_text.grid(row=3, column=0, padx=5, pady=5, sticky="nsew")
hex_button = tk.Button(frame, text="Convert Hex", command=hex_to_other)
hex_button.grid(row=4, column=0, padx=5, pady=5)

decimal_label = tk.Label(frame, text="Decimal")
decimal_label.grid(row=2, column=1, padx=5, pady=5, sticky="nw")
decimal_text = tk.Text(frame, width=20, height=15)
decimal_text.grid(row=3, column=1, padx=5, pady=5, sticky="nsew")
...
binary_label = tk.Label(frame, text="Binary")
binary_label.grid(row=2, column=2, padx=5, pady=5, sticky="nw")
binary_text = tk.Text(frame, width=20, height=15)
binary_text.grid(row=3, column=2, padx=5, pady=5, sticky="nsew")
binary_button = tk.Button(frame, text="Convert Binary", command=binary_to_other)
binary_button.grid(row=4, column=2, padx=5, pady=5)
